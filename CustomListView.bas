...
Sub Class_Globals
	...
	Public dividerHeight As Float
	
	Public div_color As Int'=Colors.White
...
Public Sub Initialize (vCallback As Object, vEventName As String,divcolor As Int,div_Height As Int)
	sv.Initialize2(0, "sv")
	items.Initialize
	panels.Initialize
	
	If divcolor=0 Then
		div_color=Colors.White
	Else
		div_color=divcolor
	End If
	
	dividerHeight = div_Height
	EventName = vEventName
	CallBack = vCallback
	sv.Color = div_color'0xFFD9D7DE 'this sets the dividers color
	Dim r As Reflector
