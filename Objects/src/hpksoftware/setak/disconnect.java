...
public class disconnect extends Activity implements B4AActivity{
	public static disconnect mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "hpksoftware.setak", "hpksoftware.setak.disconnect");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (disconnect).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "hpksoftware.setak", "hpksoftware.setak.disconnect");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "hpksoftware.setak.disconnect", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (disconnect) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (disconnect) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (disconnect) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 17;BA.debugLine="Activity.LoadLayout(\"disconnect\")";
mostCurrent._activity.LoadLayout("disconnect",mostCurrent.activityBA);
...
public static String  _btn_check_net_click() throws Exception{
 //BA.debugLineNum = 29;BA.debugLine="Sub btn_check_net_Click";
 //BA.debugLineNum = 30;BA.debugLine="If myLibrary.CheckInternet=True Then";
if (mostCurrent._mylibrary._checkinternet(mostCurrent.activityBA)==anywheresoftware.b4a.keywords.Common.True) { 
...
mostCurrent._activity.Finish();
 //BA.debugLineNum = 33;BA.debugLine="myLibrary.SetAnimation(\"file3\",\"file4\")";
mostCurrent._mylibrary._setanimation(mostCurrent.activityBA,"file3","file4");
 }else {
 //BA.debugLineNum = 35;BA.debugLine="ToastMessageShow(\"تلاش شما ناموفق بود\",True)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("تلاش شما ناموفق بود"),anywheresoftware.b4a.keywords.Common.True);
 };
