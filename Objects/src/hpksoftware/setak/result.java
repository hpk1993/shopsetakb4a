...
public class result extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "hpksoftware.setak", "hpksoftware.setak.result");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "hpksoftware.setak", "hpksoftware.setak.result");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "hpksoftware.setak.result", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
mostCurrent._searchintent = mostCurrent._activity.GetStartingIntent();
 //BA.debugLineNum = 30;BA.debugLine="If searchIntent.Action = \"android.intent.action.S";
...
_searchstring = BA.ObjectToString(mostCurrent._searchintent.GetExtra("query"));
...
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("No search action!"),anywheresoftware.b4a.keywords.Common.False);
 };
...
_ss_none = 0;
 //BA.debugLineNum = 13;BA.debugLine="Dim SS_NONE As Int : SS_NONE = 0";
_ss_none = (int) (0);
 //BA.debugLineNum = 14;BA.debugLine="Dim SS_RESULT_SUCCESS As Int : SS_RESULT_SUCCESS";
